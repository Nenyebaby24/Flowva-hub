...
const Bluebox = () => {
  ...
  return (
    <section className="min-h-screen bg-white flex items-center justify-center p-4">
      <div className="relative w-full max-w-5xl bg-blue-600 rounded-[40px] py-32 px-10 overflow-hidden flex flex-col items-center justify-center">
        <h1 className="absolute top-10 text-white text-4xl font-bold">START YOUR CAMPAIGN</h1>
        
        <div className="mt-8 md:mt-0 border-shadow flex shrink-0" >
